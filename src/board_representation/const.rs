...
pub const W_KING_ROOK_START: Position = Position::from_file_and_rank(0, 0);
pub const B_KING_ROOK_START: Position = Position::from_file_and_rank(0, 7);

pub const W_QUEEN_ROOK_START: Position = Position::from_file_and_rank(7, 0);
pub const B_QUEEN_ROOK_START: Position = Position::from_file_and_rank(7, 7);
